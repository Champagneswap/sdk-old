...
export declare const CHAMPANGE_ADDRESS: AddressMap;
export declare const WINEMAKER_ADDRESS: AddressMap;
...
export declare const CELLAR_ADDRESS: AddressMap;
export declare const GRAPE_ADDRESS: AddressMap;
export declare const CHAMPAGNESWAP_SWAPPER_ADDRESS: AddressMap;
export declare const CHAMPAGNESWAP_MULTISWAPPER_ADDRESS: AddressMap;
export declare const CHAMPAGNESWAP_MULTI_EXACT_SWAPPER_ADDRESS: AddressMap;
export declare const PEGGED_ORACLE_ADDRESS = "0x6cbfbB38498Df0E1e7A4506593cDB02db9001564";
export declare const CHAMPAGNESWAP_TWAP_0_ORACLE_ADDRESS = "0x66F03B0d30838A3fee971928627ea6F59B236065";
export declare const CHAMPAGNESWAP_TWAP_1_ORACLE_ADDRESS = "0x0D51b575591F8f74a2763Ade75D3CDCf6789266f";
