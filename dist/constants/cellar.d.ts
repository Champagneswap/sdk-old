...
export declare const ACTION_CELLAR_DEPOSIT = 20;
export declare const ACTION_CELLAR_WITHDRAW = 21;
export declare const ACTION_CELLAR_TRANSFER = 22;
export declare const ACTION_CELLAR_TRANSFER_MULTIPLE = 23;
export declare const ACTION_CELLAR_SETAPPROVAL = 24;
