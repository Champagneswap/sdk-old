...
// Function on Cellar
export const ACTION_CELLAR_DEPOSIT = 20
export const ACTION_CELLAR_WITHDRAW = 21
export const ACTION_CELLAR_TRANSFER = 22
export const ACTION_CELLAR_TRANSFER_MULTIPLE = 23
export const ACTION_CELLAR_SETAPPROVAL = 24
